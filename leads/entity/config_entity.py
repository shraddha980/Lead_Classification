...
class DataIngestionConfig:
       ...
       def __init__(self,train_pipeline_config:TrainingPipelineConfig):
           try:
              ...
              self.feature_store_file_path=(self.data_ingestion_dir,"feature_store", FILE_NAME)
              self.train_file_path=(self.data_ingestion_dir,"dataset", TRAIN_FILE_NAME)
              self.test_file_path=(self.data_ingestion_dir,"dataset", TEST_FILE_NAME)
              self.test_size=0.2
           except Exception as e:  
                raise LeadException(e,sys)
